...
export class Graph
{
    constructor ()
    {
        ...
        const xAxis_geometry = new THREE.BufferGeometry ().setFromPoints (xAxis_points);
        const yAxis_geometry = new THREE.BufferGeometry ().setFromPoints (yAxis_points);
        const zAxis_geometry = new THREE.BufferGeometry ().setFromPoints (zAxis_points);
